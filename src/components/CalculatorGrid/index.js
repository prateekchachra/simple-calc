...
const CalculatorGrid = () => {
      ...
      switch (digit.type) {
        ...
        case "SPECIAL_OPERATOR":
          ...
          if (value === "C") {
            ...
            setValues({
              ...values,
              nextValue: String(-1 * Number(values.nextValue)),
            });
          } else if (value === "%") {
            setValues({
              ...values,
              nextValue: String((Number(values.nextValue) / 100).toFixed(2)),
            });
          }
          break;
        case "OPERATOR":
          ...
          // Handling the Decimal '.' string case
            ...
            let newValue =
              values.firstValue !== "" ? calculateResult() : values.nextValue;
            setValues({
              firstValue: newValue,
              operator: digit.value,
              nextValue: "",
  ...
  return (
    <div
      ...
      onKeyDown={onDeleteKeyPress}
    >
      <div className="calculator-input-container">
        <div className="calculated-value">
          {values.firstValue !== ""
            ? String(values.firstValue) + values.operator
            : ""}
        </div>
        <input
          autoFocus
